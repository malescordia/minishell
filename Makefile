...
SRC =   src/main.c src/check_input.c src/parse.c src/quote_utils.c \
		src/expansion.c src/expansion_utils.c src/init.c src/split.c \
		src/input_utils.c src/free.c src/tokenize.c src/cmd.c \
		src/redirection.c src/error.c src/start.c src/execute.c \
		src/builtins.c src/check_cmd.c src/utils.c \
